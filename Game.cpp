...
Vec<SDL_GameController *> GamePad;
Vec<SDL_Joystick *> Joystick;

Vec<bool> JoystickButton;
...
{
	Time tm = GetSysTime();
	Txt p = AppendFName(ConfigFolder(),
